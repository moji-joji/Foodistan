          ...
          <div class="row align-items-center">
            <div class="col-12 col-lg-6 mb-10 mb-lg-0">
              <div class="mw-lg-md mb-10 mb-lg-24">
                ...
                <p class="lead lh-lg text-muted">We would like to hear from you. Your suggestions and complaints are of high value to us. Feel free to reach out to us</p>
              </div>
              <div class="row">
                <div class="col-12 col-md-6 mb-5 mb-md-0">
                  <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M18 10L6 6V38L18 42M18 10L30 6M18 10V42M30 6L42 10V42L30 38M30 6V38M30 38L18 42" stroke="#006251" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  </svg>
            ...
            <div class="col-12 col-lg-6 position-relative">
              <div class="position-relative py-12 px-10 bg-white shadow-lg text-center">
                <img class="d-none d-lg-block position-absolute bottom-100 start-50" style="height: 88px;" src="cronos-assets/elements/green-light-left.svg" alt="">
                <img class="d-none d-lg-block position-absolute top-100 start-50" style="height: 88px;" src="cronos-assets/elements/light-green-left.svg" alt="">
                <form action="#">
                  ...
                  <textarea class="form-control mb-6" name="message" cols="30" rows="10" placeholder="Your Message..." required></textarea>
