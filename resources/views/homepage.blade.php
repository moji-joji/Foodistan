 ...
 <strong>             Foodistan </strong>
        ...
        <div class="container">
          <div class="mw-2xl mx-auto text-center mb-20 mb-lg-32">
            ...
            <a class="btn btn-primary mt-5" href="#">Get Started</a>
          </div>
          <div class="row">
            ...
            <div class="col-12 col-lg-4 mb-10 mb-lg-0">
              <div class="d-flex">
                ...
                <div>
                  ...
                  <p class="text-light lead lh-lg">Don't trust us? Read what the people have to say</p>
                </div>
              </div>
            </div>
            <div class="col-12 col-lg-4">
              <div class="d-flex">
                ...
                <div>
                  ...
                  <p class="text-light lead lh-lg">Read our immersive blog to find your next hangout spot</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-12 col-lg-8 mx-auto text-center">
            ...
            <p class="mw-xl mx-auto lead text-light mb-6">Tell us your preferences and let us take care of the rest</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-lg-8 mb-16">
            <div class="mb-10">
              <img class="img-fluid w-100" style="height:400px; object-fit: cover;" src="cronos-assets/images/homepage-blog1.jpg" alt="">
            </div>
            ...
            <h6 class="mb-6 fw-normal lh-lg text-muted">Biryani, Palau, and Nihari- we all are aware of these mouth-watering food delights in Pakistan. Pakistani cuisine is a rich, exotic, and irresistible collection of dishes. From the spiciness of the Qurma to the sweetness of Kheer, every meal in Pakistan represents the nation’s love for flavorful food. However, the details of this enthralling cuisine are yet to unravel. Read more!</h6>
            <a class="link-primary text-decoration-none fw-bold" href="#">Read more</a>
          </div>
          <div class="col-12 col-lg-4 mb-16">
            <div class="mb-10">
              <img class="img-fluid w-100" style="height:400px; object-fit: cover;" src="cronos-assets/images/homepage-blog2.jpg"  alt="">
            </div>
            <span class="small text-muted" style="font-size: 12px;">10 jun 2021 19:40</span>
            <h3 class="mt-4 mb-4">Chicken Sandwich Variations</h3>
            <h6 class="mb-6 fw-normal lh-lg text-muted">Chicken is an all-time star and a versatile ingredient. The aromatic, though a little bland, white meat goes perfectly well with almost every recipe.</h6>
            <a class="link-primary text-decoration-none fw-bold" href="#">Read more</a>
          </div>
    ...
    <section class="py-20">
      <div class="container">
        <div class="py-16 py-lg-24 px-10 px-lg-28 bg-primary position-relative">
          <img class="d-none d-md-block position-absolute top-0 start-0 translate-middle" src="cronos-assets/elements/left-squares.svg" alt="">
          <img class="d-none d-md-block position-absolute top-100 start-100 translate-middle" src="cronos-assets/elements/right-squares.svg" alt="">
          <div class="row align-items-center">
        ...
        <div class="row align-items-center">
          <div class="col-12 col-lg-6 mb-8 mb-lg-0">
            <div class="mw-lg-md">
              ...
              <p class="lead lh-lg text-muted mb-6">We feature the best of the best restaurants in Pakistan, these restaurants were carefully selected after consideration of a number of factors. These factors include hygiene, cuisine type, restaurant options available, popularity, and so on.</p>
            </div>
          </div>
          <div class="col-12 col-lg-6">
            <div class="p-12 bg-light-light">
              <div class="d-flex mb-8">
                <span class="flex-shrink-0 d-flex align-items-center justify-content-center bg-secondary fw-bold me-6" style="width: 64px; height: 64px;">1</span>
                <div>
              ...
              <div class="d-flex mb-8">
                <span class="flex-shrink-0 d-flex align-items-center justify-content-center bg-secondary fw-bold me-6" style="width: 64px; height: 64px;">2</span>
                <div>
                  <h6 class="mb-3">Browse</h6>
                  <p class="lead lh-lg text-muted">Browse through the list of restaurants and see ratings</p>
                </div>
              </div>
              <div class="d-flex">
                <span class="flex-shrink-0 d-flex align-items-center justify-content-center bg-secondary fw-bold me-6" style="width: 64px; height: 64px;">3</span>
                <div>
                  <h6 class="mb-3">Enjoy</h6>
                  <p class="lead lh-lg text-muted">See the ratings and let your taste buds guide you</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <section class="pt-20">
      <div class="container position-relative text-center">
        <div class="mw-4xl mx-auto mb-16 text-center">
          ...
          <p class="mw-xl mx-auto lead lh-lg text-muted mb-6">Download the app and enjoy delicious dinners with us</p>
