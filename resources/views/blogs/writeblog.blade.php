...
<body>
    <div class="">
        ...
        <div class="d-flex justify-content-center  round shadow bg-dark  text-white ">
            <form class="w-50 my-10" action="/blog" method="post">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <textarea class="form-control rounded" name="description" rows="3" placeholder="Describe your post"></textarea>

                </div>
                <div class="mb-6">
                    <label class="form-label" for="">Content</label>
                    <textarea class="form-control rounded " name="content" rows="3" placeholder="Main content of your blog post"></textarea>
